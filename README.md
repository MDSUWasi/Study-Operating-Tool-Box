...
<h2 align="center"> 🛡️ Privacy, Safety & Security</h2>

Study Operating Tool-Box is designed to be a private vault (Only if no external settings is working on it):

1.  **Zero External Requests:** The system do not calls external APIs.
2.  **No Tracking:** There are no analytics in source code, cookies, or hidden scripts. 
...
<h3 align="right"> But here is a catch,</h3>
...
<h2 align="center">Developed as many in one study toolbox.</h2>
<h1 align="center">Study Operating Tool-Box</h2>