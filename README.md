...
* **Was-Calendar:** A temporal mapping system (Calendar) for tracking tasks and daily routines.
* **Was-To-Do List:** A to-do list system for mapping tasks.
* **Was Writer:** A distraction-free, glassmorphic editor with a built-in Focus Timer for deep-work sessions.
* **Profile:** Personalize your workspace with custom banners, profile signatures, and UI accent colors.
* **Stats:** Real-time visualization of your study hours and productivity logs.
* **Archive:** Full import/export capabilities to keep your data safe and portable.

``` And More ```

## 🛡️ Privacy, Safety & Security

Unlike modern "Cloud-First" applications, Study Operating Tools is designed to be a private vault:
